...
<xsl:stylesheet 
							...
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-body>
									<fo:table-row>
										...
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right">
											<fo:block font-weight="bold">SD</fo:block>
										</fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right">
									...
									<fo:table-row>
										...
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right">
											<fo:block font-weight="bold"><xsl:value-of select="grandVatAmt"/></fo:block>
										</fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right">
											<fo:block font-weight="bold"><xsl:value-of select="grandTaxAmt"/></fo:block>
										</fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right">
	...
	<xsl:template match="invoices/invoice">
		<fo:table-row>
			...
			<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="center" number-columns-spanned="10" ><fo:block>Items</fo:block></fo:table-cell>
		</fo:table-row>
		...
		<fo:table-row>
			...
			<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block>SD</fo:block></fo:table-cell>
			<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block>Net Amount</fo:block></fo:table-cell>
		</fo:table-row>
		<fo:table-row>
		...
		<fo:table-row>
			...
			<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right">
				<fo:block font-weight="bold"><xsl:value-of select="taxAmt"/></fo:block>
			</fo:table-cell>
			<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right">
