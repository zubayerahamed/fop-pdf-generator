			...
			<fo:page-sequence master-reference="document">
				...
				<fo:static-content flow-name="header-first">
					...
					<fo:block-container width="100%">
						<fo:block font-size="9px" margin-top="10px" text-align="right">
							...
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse" xsl:use-attribute-sets="table.font.size">
								...
								<fo:table-body>
									...
									<fo:table-row>
										...
										<fo:table-cell text-align="left">
											<fo:block><xsl:value-of select="totalAmt"/></fo:block>
										</fo:table-cell>
									</fo:table-row>
			...
			<fo:table-cell xsl:use-attribute-sets="client.table.td">
				<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
					...
					<fo:table-body>
						<fo:table-row>
							<fo:table-cell text-align="left">
								<fo:block font-weight="bold">Item Group</fo:block>
							</fo:table-cell>
							<fo:table-cell text-align="center">
								<fo:block>:</fo:block>
							</fo:table-cell>
							<fo:table-cell text-align="left">
								<fo:block font-weight="bold"><xsl:value-of select="groupName"/></fo:block>
							</fo:table-cell>
						</fo:table-row>
						
						<fo:table-row>
							<fo:table-cell text-align="left">
								<fo:block font-weight="bold">Total QTY</fo:block>
							</fo:table-cell>
							<fo:table-cell text-align="center">
								<fo:block>:</fo:block>
							</fo:table-cell>
