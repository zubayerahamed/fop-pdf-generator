...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo" xmlns:java="com.metafour.netcourier.util.FopHelper" extension-element-prefixes="java">
	...
	<xsl:template name="title">
		<!--<fo:block font-size="8pt" margin-right="0" padding="0" text-align="left"> E-mail: info@swisspostsolutions.com </fo:block> -->
			...
			<fo:table-body>
				...
				<fo:table-row height="5mm" margin-left="1mm" border="1pt solid black">
					<fo:table-cell column-width="50">
						<fo:block>
							FROM :
							<xsl:value-of select="hawb/da_ctnm" />
						</fo:block>
					</fo:table-cell>
					<fo:table-cell>
						<fo:block>
							SHIPPER REF :
							<xsl:value-of select="hawb/cs_cref" />
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
				...
				<fo:table-row height="11mm" margin-left="1mm" border="1pt solid black">
					<fo:table-cell>
						<fo:block>
							PHONE NUMBER :
							<xsl:value-of select="hawb/cl_phon" />
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-body>
			...
			<fo:table-body>
				...
				<fo:table-row height="11mm" background-color="#FFFFFE" margin-left="1mm" border="1pt solid black">
					<fo:table-cell>
						...
						<fo:block>
							PHONE NUMBER :
							<xsl:value-of select="hawb/da_phon" />
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-body>
			...
			<fo:table-body>
				...
				<fo:table-row height="11mm" background-color="#FFFFFE" border="1pt solid black" margin-left="1mm">
					<fo:table-cell>
						...
						<fo:block>
							Service Level :
							<xsl:value-of select="hawb/sl_desc" />
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-body>
