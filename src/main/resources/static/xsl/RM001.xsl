...
<xsl:stylesheet 
					...
					<fo:block-container width="100%">
						<fo:block>
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-body>
									<xsl:apply-templates select="invgroups/invgroup"/>
								</fo:table-body>
							</fo:table>
						</fo:block>
					</fo:block-container>
					...
					<fo:block-container width="100%">
						<fo:block>
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-body>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right" number-rows-spanned="2" number-columns-spanned="3"><fo:block>Grand Total</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block>Inv. Amount</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block>Discount</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block>VAT Amount</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block>Supplier VAT</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block>Card Amount</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block>Cash Amount</fo:block></fo:table-cell>
									</fo:table-row>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right"><fo:block><xsl:value-of select="invAmt"/></fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right"><fo:block><xsl:value-of select="discount"/></fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right"><fo:block><xsl:value-of select="vatAmt"/></fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right"><fo:block><xsl:value-of select="suppVatAmt"/></fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right"><fo:block><xsl:value-of select="cardAmt"/></fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right"><fo:block><xsl:value-of select="cashAmt"/></fo:block></fo:table-cell>
									</fo:table-row>
								</fo:table-body>
							</fo:table>
						</fo:block>
	...
	<xsl:template match="invgroups/invgroup">
		<fo:table-row>
					...
					<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
						...
						<fo:table-header>
							<fo:table-row>
								...
								<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="left"><fo:block>Invoice Number</fo:block></fo:table-cell>
								<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="left"><fo:block>Inv. Date</fo:block></fo:table-cell>
								<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block>Inv. Amount</fo:block></fo:table-cell>
								<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block>Discount</fo:block></fo:table-cell>
								<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block>VAT Amount</fo:block></fo:table-cell>
								<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block>Supplier VAT</fo:block></fo:table-cell>
			...
			<fo:table-cell>
				<fo:block>
					<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
						...
						<fo:table-body>
							<fo:table-row>
								<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right" number-columns-spanned="3"><fo:block>Total</fo:block></fo:table-cell>
								<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block><xsl:value-of select="invAmt"/></fo:block></fo:table-cell>
								<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block><xsl:value-of select="discount"/></fo:block></fo:table-cell>
								<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block><xsl:value-of select="vatAmt"/></fo:block></fo:table-cell>
								<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block><xsl:value-of select="suppVatAmt"/></fo:block></fo:table-cell>
								<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block><xsl:value-of select="cardAmt"/></fo:block></fo:table-cell>
								<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block><xsl:value-of select="cashAmt"/></fo:block></fo:table-cell>
							</fo:table-row>
						</fo:table-body>
					</fo:table>
				</fo:block>
	...
	<xsl:template match="invoices/invoice">
		<fo:table-row>
			...
			<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="left">
				<fo:block><xsl:value-of select="invocieNumber"/></fo:block>
			</fo:table-cell>
			<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="left">
				<fo:block><xsl:value-of select="date"/></fo:block>
			</fo:table-cell>
			<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right">
				<fo:block><xsl:value-of select="invAmt"/></fo:block>
			</fo:table-cell>
			<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right">
			...
			<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right">
				<fo:block><xsl:value-of select="suppVatAmt"/></fo:block>
			</fo:table-cell>
			<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right">
				<fo:block><xsl:value-of select="cardAmt"/></fo:block>
			</fo:table-cell>
			<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right">
				<fo:block><xsl:value-of select="cashAmt"/></fo:block>
			</fo:table-cell>
		</fo:table-row>
	</xsl:template>
