...
<!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
<!--!                                                              !-->
<!--!    File Name    : RM0356.xsl                                 !-->
<!--!    Description  : FIFO based consumed item                   !-->
...
<xsl:stylesheet 
	...
	<xsl:template match="rm036report">
					...
					<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
						...
						<fo:table-header>
							<fo:table-row>
								...
								<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block>Consumption Qty</fo:block></fo:table-cell>
								<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="center"><fo:block>Unit</fo:block></fo:table-cell>
								<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="right"><fo:block>Rate</fo:block></fo:table-cell>
						...
						<fo:table-body>
							...
							<fo:table-row>
								...
								<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right" number-columns-spanned="2">
	...
	<xsl:template match="details/detail">
		<fo:table-row>
			...
			<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="right">
				<fo:block><xsl:value-of select="lineAmount"/></fo:block>
			</fo:table-cell>
		</fo:table-row>
	</xsl:template>
