...
<!--!                                                              !-->
<!--!    File Name    : RM030.xsl                                  !-->
<!--!    Description  : Stock Status Report                        !-->
...
<xsl:stylesheet 
	...
	<xsl:template match="rm030report">
				...
				<fo:static-content flow-name="header-first">
					...
					<fo:block-container width="100%">
						...
						<fo:block text-align="center" font-size="12px" font-weight="bold" margin-top="5px">
							<xsl:value-of select="reportName"/> - ( <xsl:value-of select="reportType"/> )
						</fo:block>
					</fo:block-container>
					<fo:block-container width="100%">
					...
					<fo:block-container width="100%">
						<fo:block>
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-header>
									<fo:table-row>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="left"><fo:block>Item</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="center"><fo:block>Dater</fo:block></fo:table-cell>
