...
<!--!                                                              !-->
<!--!    File Name    : RM034.xsl                                  !-->
<!--!    Description  : Raw Item List Report                       !-->
...
<xsl:stylesheet 
	...
	<xsl:template match="rm034report">
							...
							<fo:table table-layout="fixed" width="100%" border-collapse="collapse">
								...
								<fo:table-header>
									<fo:table-row>
										...
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="left"><fo:block>Group</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="left"><fo:block>Category</fo:block></fo:table-cell>
										<fo:table-cell xsl:use-attribute-sets="client.table.th" text-align="center"><fo:block>Inventory Unit</fo:block></fo:table-cell>
									</fo:table-row>
								</fo:table-header>
	...
	<xsl:template match="items/item">
		<fo:table-row>
			<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="left">
				<fo:block><xsl:value-of select="id"/> - <xsl:value-of select="name"/></fo:block>
			</fo:table-cell>
			<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="left">
			...
			<fo:table-cell xsl:use-attribute-sets="client.table.td" text-align="center">
				<fo:block><xsl:value-of select="conunit"/></fo:block>
			</fo:table-cell>
		</fo:table-row>
	</xsl:template>
